...
/*$investigation_sql = "SELECT * FROM " . $this->config->item('db_prefix') . "patient_journey5";
...
$date = DateTime::createFromFormat('d-m-Y H:i:s', $vl['visit_month'], new DateTimeZone('Asia/Kolkata'));
...
echo $formatted;
	...
	$payload = [
        ...
        'doctor'=> $vl['booking_month'],
        'wife_phone'=> $vl['booking_date'],
        'patient_id'=> $vl['ch_fc_name'],
        'appointment_id'=> $vl['doctor_consulted'],
        'female_investigation_suggestion_list'=> $vl['patient_id'],
        'male_investigation_suggestion_list'=> $vl['patients_name'],
        'package_suggestion_list'=> $vl['centre_booking'],
        'sub_procedure_suggestion_list'=> $vl['centre_procedure'],
        'female_medicine_suggestion_list'=> $vl['patients_source'],
        'male_medicine_suggestion_list'=> $vl['patient_type'],
        'lead_id' => $vl['crm_id']
    ];
...
$investigation_sql = "SELECT * FROM " . $this->config->item('db_prefix') . "embryo_record";
$investigation_q = $this->db->query($investigation_sql);
$investigation_result = $investigation_q->result_array();
...
$select_center = "SELECT * FROM `hms_centers` WHERE center_number='$select_result_pro['origins']'";
$result_center = run_select_query($select_center);

$select_procedure = "SELECT * FROM `hms_procedures` WHERE center_number='$vl['procedure_id']'";
$result_pro = run_select_query($select_procedure); 
	...
	$payload = json_encode([
			...
			"date" => $vl['date0'],
			"no_of_straw_0" => $vl['embryos_frozen'],
