...
$query = "SELECT * FROM pcp_ndt WHERE center='India IVF Fertility Noida ' AND test_type='PGT' ORDER BY date DESC";
...
if(isset($_POST["export"])){
 if(empty($_POST["fromDate"])){
  ...
  $orderQuery = "
	SELECT * FROM pcp_ndt 
	WHERE date >= '".$_POST["fromDate"]."' AND date <= '".$_POST["toDate"]."' AND center='India IVF Fertility Noida ' AND test_type='PGT' ORDER BY date DESC";
  ...
  $sql1 = "SELECT * FROM pcp_ndt WHERE center='India IVF Fertility Noida ' AND test_type='PGT'  ORDER BY date DESC";
