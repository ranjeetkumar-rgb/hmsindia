...
<div class="col-md-12">
  <!-- Advanced Tables -->
   <div class="card">
    <div class="card-action"><h3>BEFORE STARTING IVF CYCLE</h3></div>
		    ...
		    <div class="ga-pro">
                ...
                <form action="" enctype="multipart/form-data" method="post">
                    <table width="100%" class="">
                        <h3>Before starting IVF cycle:</h3>
						<ul>
							<li>Staying healthy should be your mantra!</li>
							<li>Always eat a balanced and healthy diet including fruits, nuts and leafy veggies</li>
							<li>Aim and reach a healthy weight. A BMI of over 30 could affect your cycle negatively</li>
							<li>Exercise regularly but moderately.</li>
							<li>Consult your doctor about taking necessary vitamin supplements and other medications</li>
							<li>Do not smoke</li>
							<li>Avoid alcohol or at least try keeping your alcohol intake to bare minimum</li>
							<li>Avoid taking any stress and meditate regularly to stay positive from the beginning to the end</li>
							<li>Avoid caffeine or reduce to one or two caffeinated beverages a day</li>
