 <div class="login-box">
        <div class="logo">
            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/images/IndiaIVFClinic_logo.png"  style="width: 250px; height: 100px;" /></a>
        </div>
            <div class="card">
            <div class="body">
                ...
                <div class="row">
                        <div class="col-xs-12">
                            <p><a href="<?php echo base_url();?>">Login as employee</a></p>
                        </div>
                    </div>
                </div>
        </div>
