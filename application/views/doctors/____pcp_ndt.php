...
$query = "SELECT * FROM pcp_ndt WHERE center='India IVF Fertility Noida ' ORDER BY date DESC";
...
if(isset($_POST["export"])){
 if(empty($_POST["fromDate"])){
  ...
  $orderQuery = "
	SELECT * FROM pcp_ndt 
	WHERE date >= '".$_POST["fromDate"]."' AND date <= '".$_POST["toDate"]."' and center='India IVF Fertility Noida ' ORDER BY date DESC";
