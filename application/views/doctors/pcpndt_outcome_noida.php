...
$query = "SELECT * FROM pcp_ndt WHERE center='India IVF Fertility Noida ' AND type='OUTCOME' ORDER BY date DESC";
...
if(isset($_POST["export"])){
 if(empty($_POST["fromDate"])){
  ...
  $orderQuery = "
	SELECT * FROM pcp_ndt 
	WHERE date >= '".$_POST["fromDate"]."' AND date <= '".$_POST["toDate"]."' AND center='India IVF Fertility Noida ' AND type='OUTCOME' ORDER BY date DESC";
  ...
  $sql1 = "SELECT * FROM pcp_ndt WHERE center='India IVF Fertility Noida ' AND type='OUTCOME'  ORDER BY date DESC";
         ...
         <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover dataList" id="consultation_billing_list">
               <thead>
                  <tr>
                     <th>ID</th>
                     <th>Name of patient Undergoing Deliver</th>
                     <th>Age</th>
					 <th>Name Of Husband With Age</th>
               ...
               <tbody id="consultation_result">
                  ...
                  <tr class="odd gradeX">
					 ...
					 <td style="width:15%"><?php echo $res_val->date; ?></td>
				 </tr>
                  <?php } ?>
               </tbody>
            </table>
