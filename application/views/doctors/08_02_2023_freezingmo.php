            ...
            <table class="table table-striped table-bordered table-hover dataList" id="consultation_billing_list">
               ...
               <tbody id="consultation_result">
                  ...
                  <tr class="odd gradeX">
                     ...
                     <td>
                        <?php if(isset($_SESSION['logged_embryologist'])){ ?>
                        <a href="<?php echo base_url()?>accounts/patient_details/<?php echo $res_val->iic_id; ?>"><?php echo $res_val->iic_id; ?></a>
                        <?php }else{ ?>
                        <?php echo $res_val->iic_id; ?>
                        <?php } ?>
                     </td>
					 ...
					 <input type="date" id="first_intimation_date_<?php echo $res_val->id?>" name="first_intimation_date" value="<?php echo $res_val->first_intimation_date ?>" >
					  <?php }else{ ?>
