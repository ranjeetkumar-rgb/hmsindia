 <?php $all_method = &get_instance(); ?>
    <div class="col-md-12">
      <!-- Advanced Tables -->
      <div class="card">
       <div class="card-action"><h3>Filter's data</h3></div>
                ...
                <tr class="odd gradeX">
                  ...
                  <td>
                  	<?php if($vl['paitent_type'] == 'exist_patient'){ $patient_data = get_patient_detail($vl['paitent_id']); ?>
	                  	<a target="_blank" href="<?php echo base_url()?>patient_details/<?php echo $patient_id; ?>"><?php echo $patient_data['wife_name']; ?>
