...
<thead class="table table-bordered table-hover mt-2 table-sm red-field tableMg" style="width:100%; border:1px solid #cdcdcd;" >
<tr>
   <td style="width:50%;border-top:1px solid;border-left:1px solid;border-bottom:1px solid;padding:5px;"  colspan="4"><img src="https://indiaivf.website/assets/images/india-ivf-logo.webp"></td>
   <td style="width:50%;border-top:1px solid;border-right:1px solid;border-bottom:1px solid;padding:5px;"  colspan="3"><h3 style="margin-top:20px;">PGT EMBRYO DETAILS</h3></td>
   </tr>  
<tr style="background: #b3b9b7;">
<?php 
	        $sql1 = "Select * from ".$this->config->item('db_prefix')."appointments where paitent_id='".$patient_id."' limit 1 "; 
...
<?php }} ?>
<td colspan="3" width="33%" style="border:1px solid;padding:5px;">
<strong>IIC ID: <?php echo $patient_id; ?></strong>
</td>
</tr>
	   </thead>	
