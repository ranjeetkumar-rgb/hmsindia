...
<form class="col-sm-12 col-xs-12" method="post" action="" >
    <input type="hidden" name="action" value="update_purchase_order" />
      ...
      <div class="col-sm-12 col-xs-12 panel panel-piluku">
        ...
        <div class="panel-body profile-edit">
          ...
          <div class="row">            
            ...
            <input value="<?php echo $data['order_quantity']?>" id="order_quantity" name="order_quantity" type="number" class="form-control validate" required readonly>
            </div>
			 <div class="form-group col-sm-3 col-xs-12">
 ...
 <div class="form-group col-sm-4 col-xs-12">
		  ...
		  <div class="row"> 
			...
			<div class="form-group col-sm-4 col-xs-12">
              <label for="expiry">Bill To</label>
				...
				foreach ($all_centers as $val) { 
				// Check if the current center matches the selected one
				$selected = ($center == $val['bill_to']) ? '' : '';
				// Use `center_number` as the value (if needed) or `bill_to`
				echo '<option value="' . $val['center_number'] . '" ' . $selected . '>' . $val['center_name'] . '</option>';
				} 
				?>
				</select>
      ...
      <div class="form-group col-sm-4 col-xs-12">
             ...
             <select name="center" id="center" class="form-control" required>
              	<option value="<?php echo $data['center']?>"><?php echo $data['center']?></option>
