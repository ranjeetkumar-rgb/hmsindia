...
<div class="col-md-12">
   <div class="card" style="margin-bottom:20px;">
      ...
      <form class="row" style="margin: 0px !important;" action="<?php echo base_url().'orders/purchase_orders_list'; ?>" method="get">
         <div class="col-sm-3 col-xs-12">
            <div class="form-group">
               <label for="purchase_order">Status</label>
         ...
         <div class="col-sm-12 text-right">
            <div class="form-group">
               ...
               <a href="<?php echo base_url().'orders/purchase_orders_list'; ?>" class="btn btn-default">
               RESET
               </a>
            </div>
         </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="investigation_billing_list">
               ...
               <tbody id="investigate_result">
                  ...
                  <tr class="odd gradeX">
                     ...
                     <td><?php 
                        if (!empty($vl['pack_size']) && $vl['pack_size'] != 0) {
                            echo round($vl['vendor_price'] / $vl['pack_size'], 2);
                        } else {
                            echo "N/A"; // or 0, or handle it however is appropriate
                        }
                        ?></td>
                     ...
                     <td>
                        ...
                        <a href="<?php echo base_url('orders/edit_purchase_order/'.$vl['po_number'].'');?>" class="btn btn-large">Edit</a>
                        ...
                        <!--<a href="<?php echo base_url('orders/approve_purchase_order/'.$vl['order_number'].'');?>" class="btn btn-large">Approve</a>-->
                        | <a href="<?php echo base_url('orders/disapprove_purchase_order/'.$vl['order_number'].'');?>" class="btn btn-large">Disapprove</a>
                        <?php }}else{ ?>
...
<script type="text/javascript">
   function approveOrder(orderNumber) {
       if (confirm('Are you sure you want to approve this order?')) {
           $.ajax({
               url: '<?php echo base_url('orders/approve_purchase_order/'); ?>' + orderNumber,
