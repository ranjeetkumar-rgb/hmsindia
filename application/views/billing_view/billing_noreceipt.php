 <?php $all_method =&get_instance(); ?>
    <div class="col-md-12">
      <!-- Advanced Tables -->
       <!--Consultation  Tables -->
    	  <div class="card">
        <div class="card-action"><h3>Pending Billing Receipt</h3></div>
        <div class="clearfix"></div>
        <form action="<?php echo base_url().'billing-noreceipt'; ?>" method="get">
		   <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'billing-noreceipt'; ?>" style="text-decoration: none;">
        ...
        <div class="card-content">
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="">
              ...
              <tbody>
              <?php foreach($billing_noreceipt_consultation as $ky => $vl){ //var_dump($patient_name);die;  ?>
                <tr class="odd gradeX">
                  ...
                  <td>Consultation</td>
                  <td><a href="<?php echo base_url('upload-receipt/'.$vl['patient_id'].'/'.$vl['receipt_number'].'/consultation/'.$vl['payment_method'].'/'.$vl['ID']); ?>" class="btn btn-primary">Upload Receipt</a></td>
                </tr>
              <?php $count++; } ?>
               <tr>
                <td colspan="11">
