                     ...
                     <?php 	
                       ...
                       if(in_array($_SESSION['logged_billing_manager']['center'], $center_numbers)) {
                        ...
                        foreach($sub_procedure_suggestion_list as $key => $val){
                           ...
                           if (!empty($sub_procedure_details['code']) && 
                              array_intersect(explode(',', $sub_procedure_details['center_id']), $center_numbers)) {
                           // if (!empty($sub_procedure_details['code']) && in_array($sub_procedure_details['center_id'], $center_numbers)) {
                        ?>
                     <tr>
