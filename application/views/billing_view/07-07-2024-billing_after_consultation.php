        ...
        <?php if($form_action == "add_procedure"){ ?>
          ...
          if(!empty($billing_details['sub_procedure_suggestion_list'])){
            ...
            $sub_procedure_details = $all_method->get_procedure_details($val); //var_dump($val);die;
			  ...
			  "IP221", "IP226", "IP228", "IP230", "IP232", "IP234", "IP236", "IP238", "IP240", "IP242", "IP19", "IP62", "IP54", "IP64", "IP13", "IP22", "IP23", "IP70", "IP36", "IP71", "IP75", "IP76", "IP100", "IP78", "IP79", "IP80", "IP81", "IP82", "IP83", "IP84", "IP85", "IP86", "IP87", "IP88", "IP92", "IP222", "IP223", "IP224", "IP225", "IP227", "IP229", "IP231", "IP233", "IP235", "IP237", "IP239", "IP241", "IP245","INT78","INT65","INT13","INT02"])) {
			?>
            <tr>
		  ...
		  if(!empty($billing_details['sub_procedure_suggestion_list'])){
            ...
            $sub_procedure_details = $all_method->get_procedure_details($val); //var_dump($val);die;
              ...
              if (!empty($sub_procedure_details['code']) && in_array($sub_procedure_details['code'], ["IP55", "IP56", "IP57", "IP58", "IP89", "IP91", "IP68", "IP69", "IPD1", "IPD2", "IP67", "IP175", "IP176", "IP177", "IP178", "IP221", "IP222", "IP223", "IP224", "IP225", "IP227", "IP229", "IP231", "IP233", "IP235", "IP237", "IP239", "IP241", "IP62", "IP64", "IP13", "IP22", "IP23", "IP70", "IP36", "IP245", "IP218", "IP219"])) {
			?>
            <tr>
            ...
            <div class="row">
				...
				<?php if($billing_type == "investigation") { ?>
					<?php if($_SESSION['logged_billing_manager']['center'] == "16249589462327" ) {  ?>
						<input value="001/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
                    <?php if($_SESSION['logged_billing_manager']['center'] == "16266778858144" ) {  ?>
						<input value="002/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
					<?php if($_SESSION['logged_billing_manager']['center'] == "16267558222750" ) {  ?>
						<input value="003/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
					<?php if($_SESSION['logged_billing_manager']['center'] == "16098223739590" ) {  ?>
						<input value="004/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>
                    <?php if($_SESSION['logged_billing_manager']['center'] == "16133769691598" ) {  ?>
						<input value="005/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
                    <?php if($_SESSION['logged_billing_manager']['center'] == "1581157290" ) {  ?>
						<input value="006/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>						
				<?php } ?>
				
				<?php if($billing_type == "procedure") { ?>
					<?php if($_SESSION['logged_billing_manager']['center'] == "16249589462327" ) {  ?>
						<input value="001/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
                	<?php if($_SESSION['logged_billing_manager']['center'] == "16266778858144" ) {  ?>
						<input value="002/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
					<?php if($_SESSION['logged_billing_manager']['center'] == "16267558222750" ) {  ?>
						<input value="003/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
					<?php if($_SESSION['logged_billing_manager']['center'] == "16098223739590" ) {  ?>
						<input value="004/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>
                    <?php if($_SESSION['logged_billing_manager']['center'] == "16133769691598" ) {  ?>
						<input value="005/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>	
                    <?php if($_SESSION['logged_billing_manager']['center'] == "1581157290" ) {  ?>
						<input value="006/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="hidden" class="form-control validate">
					<?php  } ?>										
				<?php } ?>
            </div>
