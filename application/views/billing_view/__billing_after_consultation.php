        ...
        <?php if($form_action == "add_procedure"){ ?>
          ...
          if(!empty($billing_details['sub_procedure_suggestion_list'])){
            ...
            <tr>
                ...
                <td><input value="0" placeholder="Paid Price" id="paid_procedures_price_<?php echo $sub_procedure_counter;?>" class="paid_procedures_price required_value" name="paid_procedures_price_<?php echo $sub_procedure_counter;?>" type="text" class="form-control " required paid_procedures_price="<?php echo $procedures_price; ?>" ></td>
            </tr>
