        ...
        <?php if($form_action == "add_procedure"){ ?>
          ...
          $sub_procedure_counter = 1;
            ...
            <tr>
                ...
                <td><?php $sub_price = 0; if($patient_data['nationality'] == 'indian'){ $sub_price = ($sub_procedure_details['price']); }else{$sub_price = ($sub_procedure_details['usd_price']);} echo 'Rs.'.$sub_price; ?>
