      ...
      <?php } ?>
        ...
        <?php if($form_action == "add_procedure"){ ?>
		 ...
		 // if($_SESSION['logged_billing_manager']['center'] == "16249589462327" ) { 
		  if ($_SESSION['logged_billing_manager']['center'] == "16249589462327" || $_SESSION['logged_billing_manager']['center'] == "16133769691598") {
