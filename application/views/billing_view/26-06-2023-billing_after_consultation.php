        ...
        <?php if($patient_data['nationality'] == 'non-indian'){ ?>      
          ...
          <div class="row">
            <div class="form-group col-sm-6 col-xs-12">
                  ...
                  <input value="<?php echo $grand_total; ?>" name="rs_fees" placeholder="grand total" readonly="readonly" class="required_value" id="rs_after_discount" type="hidden" class="form-control " required>
                  <input value="<?php echo $grand_total; ?>" placeholder="grand total" readonly="readonly" name="rs_totalpackage" id="rs_fees" type="text" class="rs_dhee form-control required_value" required>
            </div>
            <div class="form-group col-sm-6 col-xs-12">
