  ...
  <div class="col-sm-12 col-xs-12">
    <div class="col-sm-12 col-xs-12 panel panel-piluku">
      <div class="panel-heading">
        <h3 class="heading">After consultation Billing</h3>
      </div>
      ...
      <p id="msg_area" class="delete"></p>
        ...
        <div class="col-sm-12 col-xs-12" id="add_section" style="display:none;">
            ...
            <div class="col-sm-12 col-xs-12">
                <a style="display:none;" href="<?php echo base_url('after-consultation-step-2?t=medicine_investigation_billing');?>" class="btn btn-primary" id="medicine_investigation_link">Medicine & Investigation billing</a>
