            ...
            <div class="row">
				...
				<?php if($billing_type == "investigation") { ?>
					<?php if($center['center_number'] == "16267558222750" ) {  ?>
						<input value="001/P/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>		
					<?php if($center['center_number'] == "1581156221" ) {  ?>
						<input value="003/P/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                    <?php if($center['center_number'] == "16249589462327" ) {  ?>
						<input value="003/P/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16266778858144" ) {  ?>
						<input value="002/P/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16098223739590" ) {  ?>
						<input value="004/P/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
				<?php } ?>
				
				<?php if($billing_type == "procedure") { ?>
					<?php if($center['center_number'] == "16267558222750" ) {  ?>
						<input value="001/D/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>		
					<?php if($center['center_number'] == "1581156221" ) {  ?>
						<input value="003/D/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                	<?php if($center['center_number'] == "16249589462327" ) {  ?>
						<input value="003/D/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16266778858144" ) {  ?>
						<input value="002/D/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16098223739590" ) {  ?>
						<input value="004/D/2324/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
				<?php } ?>
            </div>
