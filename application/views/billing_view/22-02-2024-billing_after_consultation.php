      ...
      <?php } ?>
        ...
        <?php if($patient_data['nationality'] == 'non-indian'){ ?>      
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-6 col-xs-12">
                  <label for="item_name">Discount (Rupee) (Required) 3</label>
            ...
            <div class="row">            
                <div class="form-group col-sm-6 col-xs-12 role">
                    ...
                    <select name="billing_from" class="required_value" id="billing_from" required>
                        <option value="">Select</option>
                        <option value="16249589462327">IndiaIVF</option>       
                    </select>
            ...
            <div class="row">
				...
				<div class="form-group col-sm-6 col-xs-12 role">
                <label for="statuss">Billing source (Required)2</label>
				
				<?php if($billing_type == "investigation") { ?>
					<?php if($center['center_number'] == "16249589462327" ) {  ?>
						<input value="001/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                    <?php if($center['center_number'] == "16266778858144" ) {  ?>
						<input value="002/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16267558222750" ) {  ?>
						<input value="003/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16098223739590" ) {  ?>
						<input value="004/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>
                    <?php if($center['center_number'] == "16133769691598" ) {  ?>
						<input value="005/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                    <?php if($center['center_number'] == "1581157290" ) {  ?>
						<input value="006/D/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>						
				<?php } ?>
				
				<?php if($billing_type == "procedure") { ?>
					<?php if($center['center_number'] == "16249589462327" ) {  ?>
						<input value="001/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                	<?php if($center['center_number'] == "16266778858144" ) {  ?>
						<input value="002/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16267558222750" ) {  ?>
						<input value="003/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($center['center_number'] == "16098223739590" ) {  ?>
						<input value="004/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>
                    <?php if($center['center_number'] == "16133769691598" ) {  ?>
						<input value="005/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                    <?php if($center['center_number'] == "1581157290" ) {  ?>
						<input value="006/P/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>										
				<?php } ?>
            </div>
