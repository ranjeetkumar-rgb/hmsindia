...
<form class="col-sm-12 col-xs-12" method="post" action="<?php echo base_url('follow-up-appointment'); ?>" enctype="multipart/form-data" >
  ...
  <div class="row">
    <div class="col-sm-12 col-xs-12 panel panel-piluku">
      <div class="panel-heading">
        <h3 class="heading">FollowUp Booking</h3>
      </div>
	...
	$.ajax({
		...
		success: function(data)
		{
			...
			if(data.status == 'new_patient'){
				...
				$('#msg_area').append(data.message+"! Followup can't be booked for new patient.");
				// $('#wife_phone').attr("readonly", true);
				// $('#wife_phone').val($('#phone_number').val());
				// $('#wife_email').empty().val("indiaivfhms@gmail.com");
