 <?php $all_method =&get_instance(); ?>
    <div class="col-md-12">
      <!-- Advanced Tables -->
       <!--Consultation  Tables -->
    	  <div class="card">
        <div class="card-action"><h3>Procedure Pending Billing Receipt</h3></div>
        <div class="clearfix"></div>
        <form action="<?php echo base_url().'billing_noreceipt_procedure'; ?>" method="get">
		   <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'billing_noreceipt_procedure'; ?>" style="text-decoration: none;">
        ...
        <div class="card-content">
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover" id="">
              ...
              <tbody>
			  <?php foreach($procedure_billing_noreceipt as $ky => $vl){ //var_dump($patient_name);die;  ?>
                <tr class="odd gradeX">
