                            ...
                            <td class="role medic_cls_1">
                                <select disabled name="medicine_name_1" class="item_select medicine_select medic-cls-1" id="medicine_name_1" count="1" required>
                                    ...
                                    <?php foreach($medicine as $key => $val){ ?>
                                        <option value="<?php echo $val['item_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" medicine="<?php echo $val['item_name']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option>
                                    <?php } ?>
                                </select>
                            </td>
                             <td><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="medicine_quantity_1" qcount="1" onkeyup="medicine_quantity_update(this)" class="medic-cls-1 medicine_quantity medicine_quantity_1 form-control" name="medicine_quantity_1" type="number" min="0" required></td>
                        ...
                        <tr class="injections_row_1" trcount="1">
                            ...
                            <td class="role injc_cls_1">
                                ...
                                <?php foreach($injections as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" injections="<?php echo $val['item_name']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
                        ...
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td class="role cons_cls_1">
                                ...
                                <?php foreach($consumables as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" consumables="<?php echo $val['item_name']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
