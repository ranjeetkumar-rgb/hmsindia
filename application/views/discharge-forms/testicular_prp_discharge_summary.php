	 ...
	 // $female_issues  = $_POST['female_issues'];
	  ...
	  //unset($_POST['IVF_Consultant']);
        ...
        if (!empty($appoitmented_date)) {
			$sql = "SELECT * FROM `testicular_prp_discharge_summary` WHERE iic_id='$iic_id' AND appoitmented_date='$appoitmented_date'";
	} else {
...
?>
<?php $physical = $physical2 = $procedures = $applicablemedicine = array();
