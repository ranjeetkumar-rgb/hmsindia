  ...
  <?php if ($_SESSION['logged_accountant']['username'] == "alan@tomorrowcapital.in" || $_SESSION['logged_accountant']['username'] == "Anshul@tomorrowcapital.in") { ?>
	...
	<?php }else{ ?>
	 ...
	 <ul class="nav" id="main-menu">
      ...
      <li> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Manage Billings<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
    ...
    <li> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Mou<span class="fa arrow"></span></a>
      ...
      <li> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Product Advisory Fee<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
      ...
      <li> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Fellowship And Training<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
