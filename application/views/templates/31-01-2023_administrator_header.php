...
<nav class="navbar-default navbar-side" style="overflow:scroll;height:100%" role="navigation">
  <div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
	  ...
	  <li class=""> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>PCPNDT<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
          <li class=""><a href="<?php echo base_url(); ?>doctors/pcp_ndt">PCPNDT Noida <span class="fa arrow"></span></a>
           <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
            <li> <a href="<?php echo base_url(); ?>doctors/pcp_ndt">PCPNDT Report Noida </a> </li>
           <li> <a href="<?php echo base_url(); ?>doctors/pcp_ndt_iui">IUI</a> </li>
             <li> <a href="<?php echo base_url(); ?>doctors/pcp_ndt_pgt">PGT</a> </li>
           <li> <a href="<?php echo base_url(); ?>doctors/pcp_ndt_tesa">TESA</a> </li>
              <li> <a href="<?php echo base_url(); ?>doctors/pcp_ndt_opu">OPU</a> </li>
             <li> <a href="<?php echo base_url(); ?>doctors/pcpndt_outcome_noida">OUTCOME</a> </li>
               <li> <a href="<?php echo base_url(); ?>doctors/pcpndt_add_outcom">ADD OUTCOME</a> </li>
          </ul>
         </li>
               <li><a href="<?php echo base_url(); ?>doctors/pcp_ndt_fhvk">PCPNDT Report FHVK</a></li>
               <li><a href="<?php echo base_url(); ?>doctors/pcp_ndt_ggn">PCPNDT Report Ggn</a></li>
          </ul>
          </li>
    </ul>
  </div>
