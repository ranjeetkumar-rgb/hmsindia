...
<title>Junior Doctor Dashboard</title>
...
<nav class="navbar-default navbar-side" style="overflow:scroll;height:100%" role="navigation">
  <div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
	  ...
	  <li> <a href="<?php echo base_url(); ?>my_ipd" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>My IPD</a>
	   <li> <a href="<?php echo base_url(); ?>doctors/informed_consent_for_psychological_counselling" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Informed Consent</a>
	  <?php }else{ ?>
      <li> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Manage Appointments<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
          <li> <a href="<?php echo base_url(); ?>jd_appointments">My Appointment</a> </li>
        </ul>
      </li>
	  <li> <a href="<?php echo base_url(); ?>my_ipd" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>My IPD</a>
      <?php } ?>
