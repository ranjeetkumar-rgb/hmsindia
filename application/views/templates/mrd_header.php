   ...
   <body>
      ...
      <nav class="navbar navbar-default top-navbar" role="navigation">
         ...
         <ul class="nav navbar-top-links navbar-right">
            ...
            <li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1"><i class="fa fa-user fa-fw"></i> <b><?php echo $_SESSION['logged_mrd']['name']?></b> <i class="material-icons right">arrow_drop_down</i></a></li>
         </ul>
      </nav>
      <!-- Dropdown Structure -->
      <ul id="dropdown1" class="dropdown-content">
         ...
         <li><a href="<?php echo base_url(); ?>logout?r=<?php echo base64_encode('logged_mrd'); ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a> </li>
      </ul>
      ...
      <nav class="navbar-default navbar-side" style="overflow:scroll;height:100%" role="navigation">
         <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
				...
				<li> <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Sign Consent Book<span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li> <a href="<?php echo base_url(); ?>doctors/consent_book">Add Sign Consent Book</a> </li>
						<li> <a href="<?php echo base_url(); ?>doctors/consent_book_list">Sign Consent Book</a> </li>
					</ul>
				</li>
			</ul>
         </div>
