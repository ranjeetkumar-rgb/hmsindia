    ...
    <div class="col-sm-12 col-xs-12 panel panel-piluku">
      ...
      <p id="msg_area" class="delete"></p>
        ...
        <div class="row">
         ...
         <div class="row">            
           <div class="form-group col-sm-6 col-xs-12">
                <label for="item_name">Wife Email (Optional)</label>
                <input value="" id="wife_email" name="wife_email" type="text" class="form-control validate in_field">
           </div>
         ...
         <div class="row">            
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <input value="" id="wife_adhar_number" name="wife_adhar_number" type="text" class="form-control validate in_field" required>
                <div class="upload_div">
	                <label>Upload adhar card</label>
    	            <input type="file" name="wife_adhar_card" class="remove_required" required />
                </div>
           ...
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <input value="" id="husband_adhar_number" name="husband_adhar_number" type="text" class="form-control validate in_field" required>
                <div class="upload_div">
            	    <label>Upload adhar card</label>
        	        <input type="file" name="husband_adhar_card" class="remove_required" required />
                </div>
         ...
         <div class="row">            
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <div class="upload_div">
    	            <input type="file" name="wife_photo" class="remove_required" required />
                </div>
           ...
           <div class="form-group col-sm-6 col-xs-12">
	           <label for="item_name">Husband Photo (Required)</label><div class="clearfix"></div>
                <div class="upload_div">
    	            <input type="file" name="husband_photo" class="remove_required" required />
                </div>
          ...
          <div class="row">            
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <input value="" id="wife_age" name="wife_age" type="text" class="form-control validate in_field" required>
           </div>
           
           <div class="form-group col-sm-6 col-xs-12">
                <label for="item_name">Husband age (Required)</label>
                <input value="" id="husband_age" name="husband_age" type="text" class="form-control validate in_field" required>
           </div>
         </div>
         ...
         <div class="row">            
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <textarea id="wife_address" name="wife_address" class="form-control validate in_field" required></textarea>
           </div>
           ...
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <textarea id="husband_address" name="husband_address" class="form-control validate in_field" required></textarea>
           </div>
         </div>
	...
	$.ajax({
		...
		success: function(data)
		{
			...
			if(data.status == 'new_patient'){
				...
				$('.upload_div input[type="file"]').val('');
				$('.upload_div input[type="file"]').prop('required',true);
				$('.upload_div').show();
