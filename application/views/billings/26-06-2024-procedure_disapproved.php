        ...
        <div class="row">
         ...
         <div class="row">            
           ...
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <input value="<?php echo $patient_data['wife_email']; ?>" required id="wife_email" name="wife_email" type="text" class="form-control validate in_field">
         ...
         <div class="row">            
           ...
           <div class="form-group col-sm-6 col-xs-12">
                ...
                <label for="item_name">Reason of visit</label>
              ...
              <section class="col-sm-12 col-xs-12 sub_procedures_section">
                  ...
                  <input type="button" class="delete-sub_procedures-row btn btn-large" value="Delete Procedure">
                 	...
                 	<div class="form-group col-sm-12 col-xs-12 pull-right">
                        ...
                        <input id="package_form" name="package_form" type="file" class="form-control validate">
...
<script>
	...
	// 		var procedures_discount = $(this).val();

	// 		given_discount += parseFloat(procedures_discount) || 0;
