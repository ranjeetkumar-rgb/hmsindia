         ...
         <div class="ga-pro">
            ...
            <form action="" method="post" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td colspan="2" style="font-size:14px; border:1px solid #000;"> <input type="hidden" id="procedure_ID_<?= $sub_procedure_counter ?>" name="procedure_ID_<?= $sub_procedure_counter ?>" value="<?= htmlspecialchars($femalemed_result['ID']) ?>" readonly>
                           <input type="text" id="procedure_name_<?php echo $sub_procedure_counter; ?>" name="procedure_name_<?php echo $sub_procedure_counter; ?>" value="<?php echo $femalemed_result['procedure_name']; ?>" readonly="">
                        </td>
               ...
               <table width="100%" class="">
                  <tbody>
                     <tr>
                        <td colspan="6"><strong>Payment Details: </strong></td>
                     </tr>
                     <tr>
   ...
   <div class="ga-pro">
      ...
      <table width="100%" style="margin-top:5px;" class="vb45rt">
         <tbody>
            ...
            <tr>
               <td colspan="6">
                  <strong>Terms & Conditions (The above-mentioned package)
               </td>
            </tr>
            <tr>
            ...
            <tr>
               <td colspan="6">
                  ►We do not do preconception sex selection and we don’t allow sex determination
               </td>
            </tr>
         </tbody>
      </table>
