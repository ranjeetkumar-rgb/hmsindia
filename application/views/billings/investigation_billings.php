  <?php $all_method =&get_instance(); ?>
    ...
    <div class="row card" style="margin-bottom:20px;">
      ...
      <div class="clearfix"></div>
        <form action="<?php echo base_url().'billings/investigation_billings'; ?>" method="get">
		   <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'billings/investigation_billings'; ?>" style="text-decoration: none;">
                <button name="btnreset" id="btnreset" type="button"  class="btn btn-secondary">RESET</button>
               </a>
            </div>
            <div class="col-sm-2" style="margin-top: 10px;">
            	<a href="<?php echo base_url('billings/Investigation-Patients'); ?>" style="text-decoration: none;">
