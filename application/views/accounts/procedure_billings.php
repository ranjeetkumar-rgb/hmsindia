<?php $all_method =&get_instance(); //var_dump($_SERVER['REDIRECT_QUERY_STRING']);die; ?>
 ...
 <div class="row card-content" style="margin-bottom:20px;">
      <div class="col-md-12"><h3> Procedure Billings </h3></div>
      <div class="clearfix"></div>
        <form action=""<?php echo base_url().'accounts/procedure_billings'; ?>" method="get">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'accounts/procedure_billings'; ?>" style="text-decoration: none;">
			  ...
			  <?php $count=1; foreach($procedure_result as $ky => $vl){
                ...
                <tr class="odd gradeX">
                  ...
                  <td> <?php if($vl['status'] == 'approved'){?>
                    ...
                    <?php if($vl['share'] == '0'){?>
                  		 <a href="javascript:void(0);" type="procedure" bill="<?php echo $vl['receipt_number']; ?>" class="disaprove_first btn btn-large">IIC share</a>
					<?php }else{ echo $currency.$vl['center_share']; ?> 
						<a href="javascript:void(0);" type="procedure" bill="<?php echo $vl['receipt_number']; ?>" class="disaprove_first btn btn-large">IIC share</a>
					<?php }?>

                    <?php }else{ echo $vl['status']; } ?>
				  ...
				  <td><?php  if($vl['status'] == 'approved'){ ?> 
				  			...
				  			<a href="javascript:void(0);" type="procedure" bill="<?php echo $vl['ID']; ?>" class="billing_disaprove_first btn btn-large" >Disapprove Billing</a>
      ...
      <!--End Advanced Tables -->
       ...
       <div class="row" id="disapprove_pop">
            ...
            <div class="col-sm-12 disapprove_pop_inner">
                ...
                <textarea class="form-control" style="height: 80px!important;" id="iic_share"></textarea>
