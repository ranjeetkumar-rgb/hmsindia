<?php $all_method =&get_instance();  ?>
 ...
 <div class="row card-content" style="margin-bottom:20px;">
      <div class="col-md-12"><h3>Cancel Medicine Billings </h3></div>
      <div class="clearfix"></div>
        <form action="<?php echo base_url().'accounts/cancel_medicine_list'; ?>" method="get">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
				<a href="<?php echo base_url().'accounts/cancel_medicine_list'; ?>" style="text-decoration: none;">
        ...
        <div class="card-content">
          ...
          <div class="table-responsive">
            ...
            <table class="table table-striped table-bordered table-hover" id="">
			  ...
			  <?php $count=1; foreach($medicine_cancel_result as $ky => $vl){
                ...
                <tr class="odd gradeX">
                  ...
                  <td><a href="<?php echo base_url(); ?>accounts/wallet/<?php echo $vl['patient_id']?>?t=procedure"><?php echo $vl['receipt_number']?></a></td>
