...
<table style="width:100%; border: 1px solid black; border-collapse: collapse;">
  ...
  <tr>
	...
	<strong>CN Number: <?php echo $data['cn_invoice'];?></strong><br/>
...
<p>This Healthcare Services is exempted from GST vide Notification No. 12/2017-Central Tax (Rate) dated 28-06-2017 and Notification No.9/2017 – Integrated Tax (Rate) dated 28-06-2017.</p>
 ...
 <?php }elseif ($_SESSION['logged_billing_manager']['employee_number'] == "16289367598583" ){ ?>
...
<table style="width:100%; margin-top:20px;">
  <tr>
    <td rowspan="2" colspan="1" style="border: 1px solid black; border-collapse: collapse;padding:5px;text-align:left;width:50%;">
	<p><strong>Pashupati Lifecare Pvt. Ltd.</strong></p>
	<p><strong>GSTIN NO:</strong> 07AAHCP5838M3ZR</p>
	<p><strong>CIN :</strong> U74999DL2014PTC264851</p>
	<p><strong>Premise Address:</strong> Lower Ground Floor, F-11, Green Park Extension,  South Delhi 110016</p>
	</td>
    <td style="border: 1px solid black; border-collapse: collapse;padding:5px;text-align:left;">
	<p>Bill To</p>
	<p><strong>Patient Name :</strong><?php echo strtoupper($patient_data['wife_name']);?></p>
...
<p>This Healthcare Services is exempted from GST vide Notification No. 12/2017-Central Tax (Rate) dated 28-06-2017 and Notification No.9/2017 – Integrated Tax (Rate) dated 28-06-2017.</p>
 ...
 <?php }elseif ($_SESSION['logged_billing_manager']['employee_number'] == "16266784114794" ){ ?>
...
<table style="width:100%; margin-top:20px;">
  <tr>
    <td rowspan="2" colspan="1" style="border: 1px solid black; border-collapse: collapse;padding:5px;text-align:left;width:50%;">
	<p><strong>Pashupati Lifecare Pvt. Ltd.</strong></p>
	<p><strong>FSSAI License No: </strong> 20823005002964</p>
    <p><strong>GSTIN NO:</strong> 06AAHCP5838M2ZU</p>
	<p><strong>CIN :</strong> U74999DL2014PTC264851</p>
	<p><strong>Premise Address:</strong> Lower Ground Floor, 167-P, Sector 51, Gurgaon 122018</p>
	</td>
    <td style="border: 1px solid black; border-collapse: collapse;padding:5px;text-align:left;">
	<p>Bill To</p>
	<p><strong>Patient Name :</strong><?php echo strtoupper($patient_data['wife_name']);?></p>
	...
	<p><strong>State Code :</strong> 06</p>
	</td>
  </tr>
   <tr>
    <td colspan="1" style="border: 1px solid black; border-collapse: collapse;padding:5px;text-align:left;width:50%;"><strong>Doctor Name: </strong> Dr Richika Sahay</td>
