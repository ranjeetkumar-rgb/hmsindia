     ...
     <div class="row">
	  ...
	  <div class="row">
	      <div class="col-sm-6 col-xs-12" style="margin-top:10px;">
            ...
            <input placeholder="File ID" id="file_id" value="<?php echo $res_val->file_id; ?>" name="file_id" type="text" class="form-control">
          </div>
          <div class="form-group col-sm-6 col-xs-12">
         ...
         <div class="form-group col-sm-6 col-xs-12">
		  ...
		  <div class="form-group col-sm-6 col-xs-12">
		    <img src="<?php echo $vl['transaction_img']; ?>" height="80" width="80">
