<?php $all_method =&get_instance(); //var_dump($_SERVER['REDIRECT_QUERY_STRING']);die; ?>
    ...
    <div class="row card-content" style="margin-bottom:20px;">
      ...
      <div class="clearfix"></div>
	    <form action="<?php echo base_url().'accounts/consultation_billings'; ?>" method="get">
		   <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'accounts/consultation_billings'; ?>" style="text-decoration: none;">
