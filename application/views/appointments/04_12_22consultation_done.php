					...
					<td>
						...
						<table width="100%">
                            ...
                            <tr>
								...
								<td colspan="1">
								<input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other_p'])?$patient_medical_info['female_pregnancy_other_p']:""; ?>" name="female_pregnancy_other_p" class="form-control" required placeholder="P" style="width:90%;">
								</td>
								<td colspan="1">
								<input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other_l'])?$patient_medical_info['female_pregnancy_other_l']:""; ?>" name="female_pregnancy_other_l" class="form-control" required placeholder="L" style="width:90%;">
								</td>
								<td colspan="1">
								<input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other_a'])?$patient_medical_info['female_pregnancy_other_a']:""; ?>" name="female_pregnancy_other_a" class="form-control" required placeholder="A" style="width:90%;">
								</td>
							</tr>
							<tr>
					...
					<td>
						...
						<table width="100%">
                            ...
                            <tr>
								<td colspan="1"><p style="color: red;"> P. L. A</p></td>
								<td colspan="1">
								<input type="text" value="<?php echo isset($patient_medical_info['male_pregnancy_other_p'])?$patient_medical_info['male_pregnancy_other_p']:"";  ?>" name="male_pregnancy_other_p" class="form-control" required Placeholder="P" style="width:90%;">
								</td>
								<td colspan="1">
								<input type="text" value="<?php echo isset($patient_medical_info['male_pregnancy_other_l'])?$patient_medical_info['male_pregnancy_other_l']:"";  ?>" name="male_pregnancy_other_l" class="form-control" required Placeholder="L" style="width:90%;">
								</td>
								<td colspan="1">
								<input type="text" value="<?php echo isset($patient_medical_info['male_pregnancy_other_a'])?$patient_medical_info['male_pregnancy_other_a']:"";  ?>" name="male_pregnancy_other_a" class="form-control" required Placeholder="A" style="width:90%;">
								</td>
							</tr>
