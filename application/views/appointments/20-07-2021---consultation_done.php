		...
		<div class="row">
			...
			<div class="col-md-12">
                    ...
                    <tr>
						...
						<td>
						<input type="text" class="form-control" name="female_blood_grp" value="<?php echo !empty($patient_medical_info['female_blood_grp'])?$patient_medical_info['female_blood_grp']:"";?>"  id="exampleInputEmail1" placeholder="Enter Blood Group">
						</td>
						<td>
						<input type="text" class="form-control" name="male_blood_grp" value="<?php echo !empty($patient_medical_info['male_blood_grp'])?$patient_medical_info['male_blood_grp']:"";?>" id="exampleInputEmail1" placeholder="Enter Blood Group">
						</td>
					</tr>
                    <tr>
					...
					<td>
						...
						<table width="100%">
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_total_pregnancies'])?$patient_medical_info['female_total_pregnancies']:""; ?>" name="female_total_pregnancies" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of live births</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_live_birth'])?$patient_medical_info['female_live_birth']:""; ?>" name="female_live_birth" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of spontaneous abortions in first trimester</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_spontaneous_abortions'])?$patient_medical_info['female_spontaneous_abortions']:"";  ?>" name="female_spontaneous_abortions" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of termination of pregnancy</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_termination_pregnancy'])?$patient_medical_info['female_termination_pregnancy']:""; ?>" name="female_termination_pregnancy" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of still births</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_still_births'])?$patient_medical_info['female_still_births']:""; ?>" name="female_still_births" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No. of ectopic pregnancy</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_ectopic_pregnancy'])?$patient_medical_info['female_ectopic_pregnancy']:""; ?>" name="female_ectopic_pregnancy" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">History of any abnormality in child</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_abnormality_child'])?$patient_medical_info['female_abnormality_child']:""; ?>" name="female_abnormality_child" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">Others</p></td>
								<td><input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other'])?$patient_medical_info['female_pregnancy_other']:""; ?>" name="female_pregnancy_other" class="form-control"></td>
							</tr>
						</table>
					</td>
					<td>
						...
						<table width="100%">
							<tr>
								<td><p style="color: red;">Total pregnancies</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_total_pregnancies'])?$patient_medical_info['male_total_pregnancies']:"";  ?>" name="male_total_pregnancies" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of live births</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_live_birth'])?$patient_medical_info['male_live_birth']:"";  ?>" name="male_live_birth" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of spontaneous abortions in first trimester</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_spontaneous_abortions'])?$patient_medical_info['male_spontaneous_abortions']:"";  ?>" name="male_spontaneous_abortions" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of termination of pregnancy</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_termination_pregnancy'])?$patient_medical_info['male_termination_pregnancy']:"";  ?>" name="male_termination_pregnancy" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No.of still births</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_still_births'])?$patient_medical_info['male_still_births']:"";  ?>" name="male_still_births" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">No. of ectopic pregnancy</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_ectopic_pregnancy'])?$patient_medical_info['male_ectopic_pregnancy']:"";  ?>" name="male_ectopic_pregnancy" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">History of any abnormality in child</p></td>
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_abnormality_child'])?$patient_medical_info['male_abnormality_child']:"";  ?>" name="male_abnormality_child" class="form-control"></td>
							</tr>
							<tr>
								<td><p style="color: red;">Others</p></td>
								<td><input type="text" value="<?php echo isset($patient_medical_info['male_pregnancy_other'])?$patient_medical_info['male_pregnancy_other']:"";  ?>" name="male_pregnancy_other" class="form-control"></td>
							</tr>
						</table>
					</tr>
					<tr>
