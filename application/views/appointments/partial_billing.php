...
//var_dump($consultation_data); echo '<br/><br/><br/>'; die;
...
<input type="hidden" name="action" value="add_partial_billing" />
...
<input type="hidden" name="doctor_id" id="doctor_id" value="<?php echo $consultation_data['doctor_id']; ?>" />
