...
function renderPagination(pagination) {
    ...
    console.log('Start calculation: ((' + pagination.current_page + ' - 1) * ' + pagination.per_page + ') + 1 = ' + start);
    console.log('End calculation: Math.min(' + pagination.current_page + ' * ' + pagination.per_page + ', ' + pagination.total + ') = ' + end);
    console.log('Displaying: Showing ' + start + ' to ' + end + ' of ' + pagination.total + ' entries');
    console.log('================================');
    
    $('#showingStart').text(start);
    $('#showingEnd').text(end);
    $('#showingTotal').text(pagination.total);
    $('#totalAppointments').text(`${pagination.total} Appointments`);
