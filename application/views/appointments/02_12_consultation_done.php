	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-12">
                    ...
                    <td><input type="text" class="form-control" value="<?php echo !empty($patient_medical_info['female_occupation'])?$patient_medical_info['female_occupation']:""; ?>" name="female_occupation" id="exampleInputEmail1" placeholder="Enter your Occupation" required></td>

                    <td><input type="text" class="form-control" value="<?php echo !empty($patient_medical_info['male_occupation'])?$patient_medical_info['male_occupation']:""; ?>" name="male_occupation"  id="exampleInputEmail1" placeholder="Enter your Occupation" required></td>
                  ...
                  <tr>
                   ...
                   <td>
				   <input type="text" value="<?php echo !empty($patient_medical_info['female_wt_ht_bmi'])?$patient_medical_info['female_wt_ht_bmi']:""; ?>" class="form-control" name="female_wt_ht_bmi" id="exampleInputEmail1" required placeholder="Female Weight">
				   <input type="text" value="<?php echo !empty($patient_medical_info['female_ht'])?$patient_medical_info['female_ht']:""; ?>" class="form-control" name="female_ht" id="exampleInputEmail1" required placeholder="Femal hieght">
				   <input type="text" value="<?php echo !empty($patient_medical_info['female_bmi'])?$patient_medical_info['female_bmi']:""; ?>" class="form-control" name="female_bmi" id="exampleInputEmail1" required placeholder="Female BMI">
				   </td>

                    <td>
					<input type="text" value="<?php echo !empty($patient_medical_info['male_wt_ht_bmi'])?$patient_medical_info['male_wt_ht_bmi']:""; ?>" class="form-control" name="male_wt_ht_bmi" id="exampleInputEmail1" required placeholder="Male Weight">
					<input type="text" value="<?php echo !empty($patient_medical_info['male_ht'])?$patient_medical_info['male_ht']:""; ?>" class="form-control" name="male_ht" id="exampleInputEmail1" required placeholder="Male hieght">
					<input type="text" value="<?php echo !empty($patient_medical_info['male_bmi'])?$patient_medical_info['male_bmi']:""; ?>" class="form-control" name="male_bmi" id="exampleInputEmail1" required placeholder="Male BMI">
					</td>
                  ...
                  <tr>
					...
					<td>
						...
						<table width="100%">
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_total_pregnancies'])?$patient_medical_info['female_total_pregnancies']:""; ?>" name="female_total_pregnancies" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_live_birth'])?$patient_medical_info['female_live_birth']:""; ?>" name="female_live_birth" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_spontaneous_abortions'])?$patient_medical_info['female_spontaneous_abortions']:"";  ?>" name="female_spontaneous_abortions" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_termination_pregnancy'])?$patient_medical_info['female_termination_pregnancy']:""; ?>" name="female_termination_pregnancy" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_still_births'])?$patient_medical_info['female_still_births']:""; ?>" name="female_still_births" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_ectopic_pregnancy'])?$patient_medical_info['female_ectopic_pregnancy']:""; ?>" name="female_ectopic_pregnancy" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['female_abnormality_child'])?$patient_medical_info['female_abnormality_child']:""; ?>" name="female_abnormality_child" class="form-control" required></td>
							...
							<tr>
								...
								<td>
								<input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other'])?$patient_medical_info['female_pregnancy_other']:""; ?>" name="female_pregnancy_other" class="form-control" required placeholder="P">
								<input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other_l'])?$patient_medical_info['female_pregnancy_other_l']:""; ?>" name="female_pregnancy_other_l" class="form-control" required placeholder="L">
								<input type="text" value="<?php echo isset($patient_medical_info['female_pregnancy_other_a'])?$patient_medical_info['female_pregnancy_other_a']:""; ?>" name="female_pregnancy_other_a" class="form-control" required placeholder="A">
								</td>
					...
					<td>
						...
						<table width="100%">
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_total_pregnancies'])?$patient_medical_info['male_total_pregnancies']:"";  ?>" name="male_total_pregnancies" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_live_birth'])?$patient_medical_info['male_live_birth']:"";  ?>" name="male_live_birth" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_spontaneous_abortions'])?$patient_medical_info['male_spontaneous_abortions']:"";  ?>" name="male_spontaneous_abortions" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_termination_pregnancy'])?$patient_medical_info['male_termination_pregnancy']:"";  ?>" name="male_termination_pregnancy" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_still_births'])?$patient_medical_info['male_still_births']:"";  ?>" name="male_still_births" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_ectopic_pregnancy'])?$patient_medical_info['male_ectopic_pregnancy']:"";  ?>" name="male_ectopic_pregnancy" class="form-control" required></td>
							...
							<tr>
								...
								<td><input type="number" value="<?php echo isset($patient_medical_info['male_abnormality_child'])?$patient_medical_info['male_abnormality_child']:"";  ?>" name="male_abnormality_child" class="form-control" required></td>
							...
							<tr>
								...
								<input type="text" value="<?php echo isset($patient_medical_info['male_pregnancy_other_l'])?$patient_medical_info['male_pregnancy_other_l']:"";  ?>" name="male_pregnancy_other_l" class="form-control" required>
								<input type="text" value="<?php echo isset($patient_medical_info['male_pregnancy_other_a'])?$patient_medical_info['male_pregnancy_other_a']:"";  ?>" name="male_pregnancy_other_a" class="form-control" required>
								</td>
					...
					<tr>
						...
						<td style="padding: 0;" colspan="2"><textarea maxlength="100" class="form-control" name="details_management_advised" placeholder="DETAILS OF MANAGEMENT ADVISED" required><?php echo !empty($patient_medical_info['details_management_advised'])?$patient_medical_info['details_management_advised']:""; ?></textarea></td>
					...
					<tr>
						...
						<div class="col-sm-12 col-xs-12 role">
							...
							<select class="multidselect_dropdown_1" multiple id="female_investigation_suggestion_list" <?php echo $disabled; ?> name="female_investigation_suggestion_list[]" required>
					...
					<?php if($appointments['partial_billing'] == 0){ ?>
						<tr>
							<th>MEDICINES ADVISED  <input style="left: 5px;position: relative;opacity: 1; top:3px;" type="checkbox" id="medicine_suggestion" value="1" <?php if(isset($patient_doctor_consultation['medicine_suggestion']) && $patient_doctor_consultation['medicine_suggestion'] == "1"){echo 'checked="checked"';}?> name="medicine_suggestion" required /></th>
							...
							<td style="padding: 0;">
								...
								<div class="col-sm-12 col-xs-12">
									...
									<select class="multidselect_dropdown" multiple id="female_medicine_suggestion_list" <?php echo $disabled; ?> required>
													...
													<?php if(!empty($female_medicine_suggestion_arr )){
														...
														<tr style='border:1px solid #000;' count="<?php echo $fmd_count; ?>">
															...
															<td style='border:1px solid #000;' class='role'>
																...
																<select style='margin:0;padding:0;' name='female_medicine_take_<?php echo $fmd_count; ?>' id='female_medicine_take_<?php echo $fmd_count; ?>' required>
													...
													<?php if(!empty($male_medicine_suggestion_arr )){
														...
														<tr style='border:1px solid #000;' count="<?php echo $mmd_count; ?>">
															...
															<td style='border:1px solid #000;' class='role'>
																...
																<select style='margin:0;padding:0;' name='male_medicine_take_<?php echo $fmd_count; ?>' id='male_medicine_take_<?php echo $fmd_count; ?>' required>
