			...
			<div class="col-md-12">
                  ...
                  <tr>
					...
					<?php $sub_procedure_suggestion_list = array(); if($appointments['partial_billing'] == 0){ ?>
						<tr>
							<th style="color: red;">MANAGEMENT ADVISED2 <input style="left: 5px;position: relative;opacity: 1; top:3px;" type="checkbox" id="procedure_suggestion" value="1" <?php if(isset($patient_doctor_consultation['procedure_suggestion']) && $patient_doctor_consultation['procedure_suggestion'] == "1"){echo 'checked="checked"';}?> name="procedure_suggestion" required /></th>
							<td colspan="2">
