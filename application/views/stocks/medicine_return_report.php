  <?php $all_method =&get_instance(); ?>
    ...
    <div class="row" style="margin-bottom:20px;">
      ...
      <div class="clearfix"></div>
        <form action="<?php echo base_url().'stocks/medicine_return_report'; ?>" method="get">
           ...
           <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'stocks/medicine_return_report'; ?>" style="text-decoration: none;">
                <button name="btnreset" id="btnreset" type="button"  class="btn btn-secondary">RESET</button>
               </a>
            </div>
			<div class="col-sm-2" style="margin-top: 10px;">
            	<a href="<?php echo base_url('stocks/Return-Medicine-Report'); ?>" style="text-decoration: none;">
                <button name="export-return-billing" type="submit"  class="btn btn-secondary" id="export-return-billing">Export Billings</button>
               </a>
            </div>
            </form>
        </div>
			...
			$consumables_arr = $data_arr['data']['consumables'];
              ...
              ?>
                ...
                <tr class="odd gradeX">
                  ...
                  <td><a href="<?php echo base_url(); ?>stocks/patient_medicine_return/?receipt_number=<?php echo $vl['receipt_number']?>"><?php echo $vl['receipt_number']?></a></td>
                  ...
                  <td><?php   if($vl['status'] == 'Pending'){ ?> 
                                    <a href="javascript:void(0)" link="<?php echo base_url();?>accounts/approve/<?php echo $vl['ID']?>?t=medicine&u=approved" class="xyx btn btn-large" >Approve</a> | <a href="javascript:void(0);" type="medicine" bill="<?php echo $vl['ID']; ?>" class="disaprove_first btn btn-large" >Disapprove</a>
					            <?php }else {
