...
<div class="col-sm-12 col-xs-12  panel panel-piluku ml-5">
  ...
  $select_result5 = run_select_query($sql2);
	...
	if(!empty($consumables_arr)){
		foreach ($consumables_arr as $row){
			...
			$consumables_price = $consumables_price + floatval($row['consumables_price']);
			$consumables_total = $consumables_total + floatval($row['consumables_total_']);
  ...
  <tr>
	...
	<?php $sql = "Select * from ".$this->config->item('db_prefix')."appointments where paitent_id='".$vl['patient_id']."'";
			$select_result = run_select_query($sql);
			$sql2 = "Select * from ".$this->config->item('db_prefix')."appointments where wife_phone='".$select_result['wife_phone']."' and paitent_type='new_patient'";
			$select_result2 = run_select_query($sql2);
			$sql3 = "Select * from ".$this->config->item('db_prefix')."centers where center_number='".$select_result2['appoitment_for']."'";
			$select_result3 = run_select_query($sql3);
			echo $select_result3['center_code']."/".$select_result2['uhid'];
		?>
	</td>
  </tr>
   <tr>
...
<table style="width:100%; margin-top:20px;">
  <tr>
	...
	<p><strong>UHID : </strong>	<?php $sql = "Select * from ".$this->config->item('db_prefix')."appointments where paitent_id='".$vl['patient_id']."'";
			$select_result = run_select_query($sql);
			$sql2 = "Select * from ".$this->config->item('db_prefix')."appointments where wife_phone='".$select_result['wife_phone']."' and paitent_type='new_patient'";
			$select_result2 = run_select_query($sql2);
			$sql3 = "Select * from ".$this->config->item('db_prefix')."centers where center_number='".$select_result2['appoitment_for']."'";
   ...
   <tr>
    <td colspan="1" style="border: 1px solid black; border-collapse: collapse;padding:5px;text-align:left;width:50%;"><?php echo $select_result5['doctor_details']; ?></td>
  </tr>
</table>
 ...
 <table style="width:100%; margin-top:30px;">
			...
			$consuma2 = ($consumables_gstdivision != 0) ? ($consumables_total_ / $consumables_gstdivision) : 0;
...
$select_result2 = run_select_query($sql2);
  ...
  <tr>
	...
	<strong><?php echo $select_result5['doctor_details']; ?><br/></strong>
	</td>
  </tr>
</table>
  <table style="width:100%;">
