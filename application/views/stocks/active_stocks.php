<?php $all_method =&get_instance(); ?>
    <div class="col-md-12">
      <!-- Advanced Tables -->
      <div class="card">
	  <div class="card-action"><h3>All Central Item Sheet</h3></div>
         <div class="clearfix"></div>
      <form action="<?php echo base_url().'stocks/active_stocks'; ?>" method="get">
            ...
            <div class="col-sm-3" style="margin-top: 20px;">
            	...
            	<a href="<?php echo base_url().'stocks/active_stocks'; ?>" style="text-decoration: none;">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover stock_list1" id="centre_stock_list1">
              ...
              <?php $count=1; foreach($investigate_result as $vl){
                      $gstamount = (!empty($vl['gstdivision']) && $vl['gstdivision'] != 0) ? ($vl['vendor_price'] / $vl['gstdivision']) : 0;
                 ?>			 
					<tr class="odd gradeX">
