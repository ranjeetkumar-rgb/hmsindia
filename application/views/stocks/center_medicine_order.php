<form class="col-sm-12 col-xs-12" method="post" action="" >
    <input type="hidden" name="action" value="center_order_item" />
    <input type="hidden" name="item_number" value="<?php echo $item_number; ?>" />
	<input type="hidden" name="employee_number" value="<?php echo $employee_number; ?>" />
      ...
      <div class="col-sm-12 col-xs-12 panel panel-piluku">
        ...
        <div class="panel-body profile-edit">
          ...
          <div class="row">
                ...
                <div class="form-group col-sm-6 col-xs-12">
             <input value="<?php echo date("Y/m/d"); ?>" placeholder="Date" id="on_date" name="on_date" type="hidden" class="form-control" required>
            </div>
                </div>
