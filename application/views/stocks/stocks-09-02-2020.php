     ...
     <!-- <div class="card-action stock_upload_box">
        ...
        <div class="show_upload" style="display:none;">
        	<form method="post" action="" enctype="multipart/form-data">
   				<input type="hidden" name="upload_stocks" value="upload_stocks" />
            ...
            <a href="<?php echo base_url();?>assets/stock_files/sample_stocks.csv" download>Download sample</a>
        </div>
      </div> -->
            ...
            <table class="table table-striped table-bordered table-hover dataList" id="">
              ...
              <?php foreach($data as $ky => $vl){ ?>
                <tr class="odd gradeX">
                  ...
                  <td><a href="<?php echo base_url();?>stocks/edit?item_number=<?php echo $vl['item_number']?>" class="edit"><i class="material-icons">edit</i></a> <!--<a href="<?php echo base_url();?>stocks/delete?item_number=<?php echo $vl['item_number']?>" class="delete"><i class="material-icons">delete</i></a>--></td>
                </tr>
              <?php } ?>
              </tbody>
            </table>
