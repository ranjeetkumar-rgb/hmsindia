                  ...
                  <table>
                    ...
                    <tbody id="injections_table_body">
                        <tr class="injections_row_1" trcount="1">
                            ...
                            <td><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="injections_quantity_1" qcount="1" onkeyup="injections_quantity_update(this)" class="injc-cls-1 injections_quantity injections_quantity_1 form-control" name="injections_quantity_1" type="number" min="0" required></td>
