 <?php $all_method =&get_instance(); ?>
  <form class="col-sm-12 col-xs-12" method="post" action="" >
    <input type="hidden" name="action" value="add_center_new_item" />
    <div class="row">
      <div class="col-sm-12 col-xs-12 panel panel-piluku">
        ...
        <div class="panel-body profile-edit">
          ...
          <div class="form-group col-sm-4 col-xs-12">
              <label for="item_name">Invoice Number (Required)</label>
              <input value="" placeholder="Invoice No" readonly="readonly" id="invoice_no" name="invoice_no" type="text" class="form-control validate" required>
            </div>
          ...
          <div class="form-group col-sm-6 col-xs-12">
              ...
              <input value="" placeholder="Date Of Purchase" id="date_of_purchase" readonly="readonly" name="date_of_purchase" type="text" class="form-control validate">
            </div>
          </div>
	...
	$(function(){
	  ...
	  $('.select2').select2({
		...
		var data = $(".select2 option:selected").val();
            ...
            $('#invoice_no').val(data.stock_data.invoice_no);
            ...
            $('#date_of_purchase').val(data.stock_data.date_of_purchase);
