  <?php $all_method =&get_instance(); ?>
    ...
    <div class="card">
       ...
       <form action="<?php echo base_url().'stocks/all_center_audit_report'; ?>" method="get">
		   ...
		   <div class="col-sm-3 col-xs-12">
            ...
            <div class="col-sm-3" style="margin-top: 20px;">
				...
				<a href="<?php echo base_url().'stocks/all_center_audit_report'; ?>" style="text-decoration: none;">
        ...
        <div class="card-content">
          ...
          <input type="hidden" name="action" value="all_center_audit_report" />
              ...
              <tbody id="table_content">
				<?php $count=1; foreach($investigate_result as $vl){ ?>
					<tr class="odd gradeX">
						...
						<td><input type="text" value="<?php echo $_SESSION['logged_central_stock_manager']['name']?>" id="requisition" name="requisition[]" readonly=""></td>
						<td><input type="text" value="<?php $employee_name = $all_method->get_employee_name($vl['employee_number']); echo $employee_name; ?>" id="employee_name" name="employee_name[]" readonly=""></td>
					</tr>
				<?php $count++;} ?>
			  </tbody>
            </table>
