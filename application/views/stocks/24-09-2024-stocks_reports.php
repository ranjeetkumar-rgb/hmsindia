<?php $all_method =&get_instance(); ?>
    ...
    <form action="<?php echo base_url().'stocks/stocks_reports'; ?>" method="get">
	  <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
		   ...
		   <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            	<label>Date</label>
              <input type="text" class="particular_date_filter form-control" id="enddate" name="enddate" value="<?php echo $enddate;?>" />
            </div>
            <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
        ...
        <tr class="odd gradeX">
          ...
          <td><a target="_blank" href="<?php echo base_url()?>/stocks/consumption_price?start_date=&end_date=&patient_id=<?php echo $vl['patient_id']; ?>&btnsearch="><?php $patient_data = get_patient_detail($vl['patient_id']); echo  strtoupper($patient_data['wife_name']);?></td>
				</tr>
			 <?php $count++;} ?>
			   <tr>
                <td colspan="11">
