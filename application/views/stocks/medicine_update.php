...
<form class="col-sm-12 col-xs-12" method="post" action="" >
    ...
    <input type="hidden" id="patient_id" name="patient_id" value="<?php echo $vl['patient_id']; ?>" />
        ...
        <div class="panel-heading">
		 ...
		 <table style="width:100%; margin-top:50px;">
                    <tr>
						...
						<th  style="border: 1px solid black; border-collapse: collapse;padding:5px; text-align:left;">Total Price</th>
                    </tr>
        ...
        <div class="panel-body profile-edit">
          ...
          <div class="row">
            <div class="form-group col-sm-6 col-xs-12">
              ...
              <input value="<?php echo $vl['patient_id']; ?>" readonly="readonly" placeholder="Patient Id" id="patient_id" name="patient_id" type="text" class="form-control validate" required>
            </div>
            <div class="form-group col-sm-6 col-xs-12">
              <label for="item_name">Receipt Number</label>
              <input value="<?php echo $vl['receipt_number']; ?>" readonly="readonly" id="receipt_number" name="receipt_number" type="text" class="form-control validate" required>
            </div>
			 <div class="form-group col-sm-6 col-xs-12">
              <label for="item_name">Patient Detail Name</label>
              <input value="<?php echo $vl['patient_detail_name']; ?>"  placeholder="Item name" id="patient_detail_name" name="patient_detail_name" type="text" class="form-control validate" required>
            </div>
			 <div class="form-group col-sm-6 col-xs-12">
              <label for="item_name">Payment Done</label>
              <input value="<?php echo $vl['payment_done']; ?>"  placeholder="Payment Done" id="payment_done" name="payment_done" type="text" class="form-control validate" required>
            </div>
			<div class="form-group col-sm-6 col-xs-12 role">
                    <label for="statuss">Payment mode</label>
                    <select name="payment_method" id="payment_method">
                        <option value=""><?php echo $vl['payment_method']; ?></option>
		 ...
		 <div class="row">
            <div class="form-group col-sm-6 col-xs-12">
              <label for="company">Consumables Quantity</label>
              <textarea id="medicine_history" name="medicine_history"><?php echo $vl['data']; ?></textarea>
            </div>
        </div>
      ...
      <div class="panel-body profile-edit">
        ...
        <div class="row" id="grand_total_section">
         <div class="form-group col-sm-12 col-xs-12">
          <input type="submit" id="submitbutton create_billing" class="btn btn-large" value="Submit" />
        </div>
          </div>
