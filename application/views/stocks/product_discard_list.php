<?php $all_method =&get_instance(); ?>
    <div class="col-md-12">
      <!-- Advanced Tables -->
     <div class="card">
     <div class="col-md-12"><h3>Product Discard List</h3></div>
		<form action="<?php echo base_url().'stocks/product_discard_list'; ?>" method="get">
           ...
           <div class="col-sm-3 col-xs-12">
            ...
            <a href="<?php echo base_url().'stocks/product_discard_list'; ?>" style="text-decoration: none;">
