        ...
        <div class="panel-body profile-edit">
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-6 col-xs-12" style="display:none">
                  ...
                  <input value="10" placeholder="Safety stock" id="safety_stock" name="safety_stock" type="hidden" class="form-control validate">
            </div>

            <div class="form-group col-sm-6 col-xs-12">
              <label for="expiry">MRP (Unit) (Required)</label>
