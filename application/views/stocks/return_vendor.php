          ...
          <div class="row">            
            ...
            <div class="form-group col-sm-6 col-xs-12">
             ...
             <div class="form-group col-sm-6 col-xs-12">
				  ...
				  <p> <input value="<?php echo $data['company']; ?>" id="company" name="company" type="text" class="form-control validate" required></p>
           </div>        
            <div class="form-group col-sm-6 col-xs-12">
            ...
            <div class="form-group col-sm-6 col-xs-12">
              <label for="expiry">Employee Number</label>
			...
			<div class="form-group col-sm-6 col-xs-12">
              ...
              <input value="<?php echo $data['reason']?>" id="reason" name="reason" type="text" class="form-control" required>
            </div>
			<div class="form-group col-sm-6 col-xs-12">
              <label for="expiry">Expiry Date</label>
              <input value="<?php echo $data['expiry']?>" id="expiry" name="expiry" type="text" class="form-control" required>
            </div>
          </div>
