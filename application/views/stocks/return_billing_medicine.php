...
<form class="col-sm-12 col-xs-12" id="add_billing_form" method="post" action="">
  <input type="hidden" name="action" value="return_billing_medicine" />
  
  <div class="row">
    <div class="col-sm-12 col-xs-12 panel panel-piluku" id="procedure_details">
      <div class="panel-heading">
        <h3 class="heading">Return Medicine Billing</h3>
      </div>
                        ...
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td class="role cons_cls_1">
                                ...
                                <?php foreach($consumables as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" ID="<?php echo $val['ID']; ?>" batch_number="<?php echo $val['batch_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" consumables="<?php echo $val['item_name']; ?>" product_vendor_price="<?php echo $val['product_vendor_price']; ?>" expiry="<?php echo $val['expiry']; ?>" mrp="<?php echo $val['mrp']; ?>" hsn="<?php echo $val['hsn']; ?>" gstrate="<?php echo $val['gstrate']; ?>" gstdivision="<?php echo $val['gstdivision']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['batch_number']; ?>) (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
							...
							<td><input value="" placeholder="Total" readonly="readonly" id="consumables_total_1" class="cons-cls-1 consumables_total form-control" name="consumables_total_1" type="text" required>
          ...
          <div class="row">
           ...
           <div class="form-group col-sm-6 col-xs-12 hospital_id_section">
				...
				<div class="form-group col-sm-6 col-xs-12" style="display:none;">
				  ...
				  <input value="1" placeholder="stutus type" id="stutus_type" name="stutus_type" type="hidden" class="form-control ">
