  <?php $all_method =&get_instance(); ?>
    <div class="col-md-12">
      ...
      <form action="<?php echo base_url().'stocks/audit_report'; ?>" method="get">
           ...
           <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'stocks/audit_report'; ?>" style="text-decoration: none;">
                <button name="btnreset" id="btnreset" type="button"  class="btn btn-secondary">RESET</button>
               </a>
            </div>
			<div class="col-sm-2" style="margin-top: 10px;">
            	<a href="<?php echo base_url('stocks/Audit-Report'); ?>" style="text-decoration: none;">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover stock_list1" id="centre_stock_list1">
              ...
              <?php $count=1; foreach($investigate_result as $vl){?>
                <tr class="odd gradeX">
				  <td><a href="<?php echo base_url(); ?>stocks/update_audit_report?id=<?php echo $vl['id']?>"><?php echo $vl['item_name']?></td>
				  <td><?php echo $vl['batch_number']?></td>
				  <td><?php echo $vl['quantity']?></td>
				  <td><?php echo $vl['physical_quantity']?></td>
				  <td><?php echo $vl['register_quantity']?></td>
				  <td><?php echo $vl['short']?></td>
				  <td><?php echo $vl['excess']; ?></td>
                  <td><?php echo $vl['damage']; ?></td>
				  <td><?php echo $vl['expiry']?></td>
				  <td><?php echo $vl['expiry_day']?></td>
				  <td><?php echo $vl['discard']?></td>
				  ...
				  <td><?php echo $vl['item_below_min']?></td>
				  <td><?php echo $vl['near_expiry']?></td>
				  <td><?php echo $vl['requisition']?></td>
