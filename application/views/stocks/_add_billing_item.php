                    ...
                    <tbody id="medicine_table_body">
                        <tr class="medicine_row_1" trcount="1">
                            ...
                            <td class="role medic_cls_1">
                             ...
                             <td><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="medicine_quantity_1" qcount="1" class="medic-cls-1 medicine_quantity medicine_quantity_1 form-control" name="medicine_quantity_1" type="number" min="0" required></td>
                  ...
                  <table>
                    ...
                    <tbody id="injections_table_body">
                        <tr class="injections_row_1" trcount="1">
                            ...
                            <td><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="injections_quantity_1" qcount="1" class="injc-cls-1 injections_quantity injections_quantity_1 form-control" name="injections_quantity_1" type="number" min="0" required></td>
                  ...
                  <table>
                    ...
                    <tbody id="consumables_table_body">
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="consumables_quantity_1" qcount="1" class="cons-cls-1 consumables_quantity consumables_quantity_1 form-control" name="consumables_quantity_1" type="number" min="0" required></td>
