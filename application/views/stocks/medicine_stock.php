 <?php $all_method =&get_instance(); ?>
      ...
      <div class="clearfix"></div>
        <form action="<?php echo base_url().'stocks/medicine_stock'; ?>" method="get">
           ...
           <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
			...
			<div class="col-sm-2" style="margin-top: 10px;">
            	<a href="<?php echo base_url('stocks/Medicine-Stock'); ?>" style="text-decoration: none;">
                <button name="export-cash-medicine" type="submit"  class="btn btn-secondary" id="export-cash-medicine">Export Cash Medicine</button>
               </a>
            </div>
			<div class="col-sm-2" style="margin-top: 10px;">
            	<a href="<?php echo base_url('stocks/Return-Medicine-Stock'); ?>" style="text-decoration: none;">
                <button name="export-return-medicine" type="submit"  class="btn btn-secondary" id="export-return-medicine">Export Return Medicine</button>
               </a>
            </div>
            </form>
        </div>
	...
	$consumables_pack_size = 0;	
	$consumables_hsn = 0;	
	$consumables_gstrate = 0;
	$consumables_gstdivision = 0;
	if(!empty($vl['data'])){
	...
	if(!empty($consumables_arr)){
		foreach ($consumables_arr as $row){
			...
			$consumables_pack_size = $row['consumables_pack_size'];
			$consumables_vendor_price = $row['consumables_vendor_price'];
			...
			echo $vl['hospital_id'];
			 ...
			 echo '</td><td>';
			  ...
			  echo '</td><td>'; 
			  echo $row['consumables_pack_size'];
			   echo '</td><td>';
			  ...
			  echo '</td><td>';
			   echo $consumables_price;
			    echo '</td><td>';
			   echo $consumables_vendor_price;
			  echo '</td><td>';
			   echo $consumables_discount_;
			  echo '</td><td>';
			  echo $consumables_total_;
			  echo '</td><td>';
			  echo $vl['employee_number'];
			  echo '</td><td>';
			  echo $vl['status'];
			    echo '</td><td>';
