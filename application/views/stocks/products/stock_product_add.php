          ...
          <div class="form-group col-sm-6 col-xs-12">
             ...
             <select id="name" name="name" class="select2 form-control" required>
              	...
              	<?php foreach($medicines as $key => $value){ ?>
                	<option value="<?php echo $value['name']; ?>"><?php echo $value['name']; ?> - <?php echo $value['mrp']; ?></option>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6 col-xs-12">
                      ...
                      <input value="1" placeholder="Consumption unit" id="consumption_unit" readonly="" name="consumption_unit" type="number" class="form-control validate" required>
