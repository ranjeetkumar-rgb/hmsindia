                        ...
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td class="role cons_cls_1">
                                ...
                                <?php foreach($consumables as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" ID="<?php echo $val['ID']; ?>" batch_number="<?php echo $val['batch_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" mrp="<?php echo $val['mrp']; ?>" consumables="<?php echo $val['item_name']; ?>" vendor_price="<?php echo $val['vendor_price']; ?>" expiry="<?php echo $val['expiry']; ?>" gstrate="<?php echo $val['gstrate']; ?>" hsn="<?php echo $val['hsn']; ?>" pack_size="<?php echo $val['pack_size']; ?>" gstdivision="<?php echo $val['gstdivision']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['batch_number']; ?>) (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
				...
				<div class="form-group col-sm-6 col-xs-12" style="display:none;">
                  ...
                  <?php } ?>
				    ...
				    <?php if($_SESSION['logged_billing_manager']['employee_number'] == "16249617235059" ){ ?>
						<input value="001/O/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
                	<?php if($_SESSION['logged_billing_manager']['employee_number'] == "16266784114794" ){ ?>
						<input value="002/O/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($_SESSION['logged_billing_manager']['employee_number'] == "16289367598583" ){ ?>
						<input value="003/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
					<?php if($_SESSION['logged_billing_manager']['employee_number'] == "16299510247261" ){ ?>
						<input value="005/O/<?php $year = date("y"); echo $year, $year+1; ?>/" id="series_number" name="series_number" type="text" class="form-control validate">
					<?php  } ?>	
				</div>
