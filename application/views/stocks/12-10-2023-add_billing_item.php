                  ...
                  <table>
                    ...
                    <tbody id="medicine_table_body">
                        <tr class="medicine_row_1" trcount="1">
                            ...
                            <td class="role medic_cls_1">
                                <select disabled name="medicine_name_1" class="item_select medicine_select medic-cls-1" id="medicine_name_1" count="1" required>
                                    ...
                                    <?php foreach($medicine as $key => $val){ ?>
                                        <option value="<?php echo $val['item_number']; ?>" ID="<?php echo $val['ID']; ?>" batch_number="<?php echo $val['batch_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" medicine="<?php echo $val['item_name']; ?>" product_vendor_price="<?php echo $val['product_vendor_price']; ?>" expiry="<?php echo $val['expiry']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option>
                                    <?php } ?>
                                </select>
                            </td>
							
                        
                             <td><input value="" item_number="" placeholder="ID" readonly="readonly" id="medicine_ID_1" class="cons-cls-1 medicine_ID_1 form-control" name="medicine_ID_1" type="hidden" required><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="medicine_quantity_1" qcount="1" onkeyup="medicine_quantity_update(this)" class="medic-cls-1 medicine_quantity medicine_quantity_1 form-control" name="medicine_quantity_1" type="number" min="0" required></td>
                          ...
                          <td><input value="" placeholder="Price" readonly="readonly" id="medicine_price_1" class="medic-cls-1 medicine_price form-control" name="medicine_price_1" type="text" required><input value="" item_number="" id="medicine_product_vendor_price_1" class="cons-cls-1 medicine_product_vendor_price_1 form-control" name="medicine_product_vendor_price_1" type="hidden"><input value="" item_number="" id="medicine_expiry_1" class="cons-cls-1 medicine_expiry_1 form-control" name="medicine_expiry_1" type="hidden"></td>
                  ...
                  <table>
                    ...
                    <tbody id="injections_table_body">
                        <tr class="injections_row_1" trcount="1">
                            ...
                            <td class="role injc_cls_1">
                                ...
                                <?php foreach($injections as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" ID="<?php echo $val['ID']; ?>" batch_number="<?php echo $val['batch_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" injections="<?php echo $val['item_name']; ?>" product_vendor_price="<?php echo $val['product_vendor_price']; ?>" expiry="<?php echo $val['expiry']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
							 
                        
                            <td><input value="" item_number="" placeholder="ID" readonly="readonly" id="injections_ID_1" class="cons-cls-1 injections_ID_1 form-control" name="injections_ID_1" type="hidden" required><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="injections_quantity_1" qcount="1" onkeyup="injections_quantity_update(this)" class="injc-cls-1 injections_quantity injections_quantity_1 form-control" name="injections_quantity_1" type="number" min="0"></td>
                        ...
                        <td><input value="" placeholder="Open Stock" readonly="readonly" id="injections_stock_1" class="cons-cls-1 injections_stock_1 form-control" name="injections_stock_1" type="text" required></td> 
                          <td><input value="" placeholder="Price" readonly="readonly" id="injections_price_1" class="injc-cls-1 injections_price form-control" name="injections_price_1" type="text" required><input value="" item_number="" id="injections_product_vendor_price_1" class="cons-cls-1 injections_product_vendor_price_1 form-control" name="injections_product_vendor_price_1" type="hidden"><input value="" item_number="" id="injections_expiry_1" class="cons-cls-1 injections_expiry_1 form-control" name="injections_expiry_1" type="hidden"></td>
                          <td><input type="checkbox" class="statuss" name="record"></td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td class="role cons_cls_1">
                                ...
                                <?php foreach($consumables as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" ID="<?php echo $val['ID']; ?>" batch_number="<?php echo $val['batch_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" consumables="<?php echo $val['item_name']; ?>" product_vendor_price="<?php echo $val['product_vendor_price']; ?>" expiry="<?php echo $val['expiry']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
							 
                        
                            <td><input value="" item_number="" placeholder="ID" readonly="readonly" id="consumables_ID_1" class="cons-cls-1 consumables_ID_1 form-control" name="consumables_ID_1" type="hidden" required><input disabled value="" item_number="" placeholder="Consumption/patient (unit)" id="consumables_quantity_1" qcount="1"  onkeyup="consumables_quantity_update(this)" class="cons-cls-1 consumables_quantity consumables_quantity_1 form-control" name="consumables_quantity_1" type="number" min="0" required></td>
                            ...
                            <td><input value="" placeholder="Price" readonly="readonly" id="consumables_price_1" class="cons-cls-1 consumables_price form-control" name="consumables_price_1" type="text" required>
						    <input value="" item_number="" id="consumables_product_vendor_price_1" class="cons-cls-1 consumables_product_vendor_price_1 form-control" name="consumables_product_vendor_price_1" type="hidden">
							<input value="" item_number="" id="consumables_expiry_1" class="cons-cls-1 consumables_expiry_1 form-control" name="consumables_expiry_1" type="hidden"></td>                   
                            <td><input type="checkbox" class="statuss" name="record"></td>
                        </tr>
                    </tbody>
                </table>                
...
$(document).on('blur',"#patient_id",function(e) {
	 ...
	 $(document).on('change',".medicine_select",function(e) {
		...
		$('#medicine_total').val('');
		$('#medicine_product_vendor_price_'+count).val('');
		...
		if(serial != ''){
			...
			$('#medicine_product_vendor_price_'+count).val(product_vendor_price);
	 ...
	 $(document).ready(function(){
        $(".add-medicine-row").click(function(){
            ...
            var markup = '<tr class="medicine_row_'+count+'" trcount="'+count+'"><td><input type="checkbox" class="active-statuss" rel="medicine"  index="'+count+'"></td><td><input value="" placeholder="Serial Number" readonly="readonly" id="medicine_serial_'+count+'" class="medic-cls-'+count+' form-control medicine_serial_'+count+'" name="medicine_serial_'+count+'" type="text" required></td><td class="role medic_cls_'+count+'"><select disabled name="medicine_name_'+count+'" class="medic-cls-'+count+' item_select medicine_select form-control" id="medicine_name_'+count+'" count="'+count+'" required><option value="">Select</option><?php foreach($medicine as $key => $val){ ?><option value="<?php echo $val['item_number']; ?>" ID="<?php echo $val['ID']; ?>" batch_number="<?php echo $val['batch_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" medicine="<?php echo $val['item_name']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['expiry']; ?>)</option><?php } ?></select></td><td><input value="" placeholder="ID" readonly="readonly" id="medicine_ID_'+count+'" class="medic-cls-'+count+' medicine_ID_'+count+' form-control" name="medicine_ID_'+count+'" type="hidden" required><input value="" qcount="'+count+'" placeholder="Consumption/patient (unit)" onkeyup="medicine_quantity_update(this)" disabled item_number="" id="medicine_quantity_'+count+'" class="medic-cls-'+count+' medicine_quantity medicine_quantity_'+count+' form-control" name="medicine_quantity_'+count+'" type="number" min="0" required></td><td><input value="" placeholder="Batch Number" readonly="readonly" id="medicine_batch_number_'+count+'" class="cons-cls-'+count+' medicine_batch_number form-control "  name="medicine_batch_number_'+count+'" type="text" required></td><td><input value="" placeholder="Open Stock" readonly="readonly" id="medicine_stock_'+count+'" class="medic-cls-'+count+' medicine_stock_'+count+' form-control" name="medicine_stock_'+count+'" type="text" required></td><td><input value="" placeholder="Price" readonly="readonly" id="medicine_price_'+count+'" class="medic-cls-'+count+' medicine_price form-control" name="medicine_price_'+count+'" type="text" required></td><td><input type="checkbox" class="statuss" name="record"></td></tr>';
...
<script>
	 $(document).on('change',".injections_select",function(e) {
		...
		$('#injections_product_vendor_price_'+count).val('');
		...
		if(serial != ''){
			...
			$('#injections_product_vendor_price_'+count).val(product_vendor_price);
