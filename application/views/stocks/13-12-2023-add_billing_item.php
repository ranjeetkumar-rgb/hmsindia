                    ...
                    <tbody id="medicine_table_body">
                        <tr class="medicine_row_1" trcount="1">
                           ...
                           <td>
						       ...
						       <input value="" item_number="" placeholder="MRP" id="medicine_mrp_1" class="cons-cls-1 medicine_mrp_1 form-control" name="medicine_mrp_1" type="hidden">
                          ...
                          <td><input value="" placeholder="Price" readonly="readonly" id="medicine_price_1" class="medic-cls-1 medicine_price form-control" name="medicine_price_1" type="text" required><input value="" item_number="" id="medicine_vendor_price_1" class="cons-cls-1 medicine_vendor_price_1 form-control" name="medicine_vendor_price_1" type="hidden"><input value="" item_number="" id="medicine_expiry_1" class="cons-cls-1 medicine_expiry_1 form-control" name="medicine_expiry_1" type="hidden">
                    ...
                    <tbody id="injections_table_body">
                        <tr class="injections_row_1" trcount="1">
							...
							<input value="" item_number="" placeholder="injections" id="injections_company_1" class="cons-cls-1 injections_company_1 form-control" name="injections_company_1" type="hidden">
						       ...
						       <input value="" item_number="" placeholder="MRP" id="injections_mrp_1" class="cons-cls-1 injections_mrp_1 form-control" name="injections_mrp_1" type="hidden">
                        ...
                        <td><input value="" placeholder="Open Stock" readonly="readonly" id="injections_stock_1" class="cons-cls-1 injections_stock_1 form-control" name="injections_stock_1" type="text" required></td> 
                          <td><input value="" placeholder="Price" readonly="readonly" id="injections_price_1" class="injc-cls-1 injections_price form-control" name="injections_price_1" type="text" required><input value="" item_number="" id="injections_vendor_price_1" class="cons-cls-1 injections_vendor_price_1 form-control" name="injections_vendor_price_1" type="hidden"><input value="" item_number="" id="injections_expiry_1" class="cons-cls-1 injections_expiry_1 form-control" name="injections_expiry_1" type="hidden">
                  ...
                  <table>
                    ...
                    <tbody id="consumables_table_body">
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td><input value="" item_number="" placeholder="ID" readonly="readonly" id="consumables_ID_1" class="cons-cls-1 consumables_ID_1 form-control" name="consumables_ID_1" type="hidden" required>
							<input value="" item_number=""  id="consumables_company_1" class="cons-cls-1 consumables_company_1 form-control" name="consumables_company_1" type="hidden">
						       ...
						       <input value="" item_number="" id="consumables_mrp_1" class="cons-cls-1 consumables_mrp_1 form-control" name="consumables_mrp_1" type="hidden">
