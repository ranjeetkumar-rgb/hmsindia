            ...
            <div id="main_div">
            	<div class="row">            
                   ...
                   <div class="form-group col-sm-6 col-xs-12">
                        ...
                        <input value="<?php echo getReceiptGUID(); ?>" placeholder="Receipt number" id="receipt_number" name="receipt_number" readonly="readonly" type="text" class="form-control required_value" required>
                   </div>
                 </div>
                        ...
                        <tr class="consumables_row_1" trcount="1">
                            ...
                            <td class="role cons_cls_1">
                                ...
                                <?php foreach($consumables as $key => $val){ ?>
                                    <option value="<?php echo $val['item_number']; ?>" quantity="<?php echo $val['quantity']; ?>" fees="<?php echo $val['price']; ?>" consumables="<?php echo $val['item_name']; ?>"> <?php echo $val['item_name']; ?> (<?php echo $val['batch_number']; ?>) (<?php echo $val['expiry']; ?>)</option>
                                <?php } ?>
                                </select>
                            </td>
          ...
          <div class="row">
           ...
           <div class="form-group col-sm-6 col-xs-12 hospital_id_section">
				...
				<div class="form-group col-sm-6 col-xs-12" style="display:none;">
				  ...
				  <input value="Pending" id="status" name="status" type="hidden" class="form-control ">
