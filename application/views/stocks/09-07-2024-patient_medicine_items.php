...
<div class="col-sm-12 col-xs-12  panel panel-piluku ml-5">
  ...
  <?php 
	...
	?>
	<input type='button' id='btn' value='Send to Patient' class="btn btn-primary pull-right" onclick='sendonwhatsapp("<?php echo $select_result['wife_phone']; ?>");'>
...
<div>
 ...
 <?php }elseif ($_SESSION['logged_billing_manager']['employee_number'] == "16445582259073" ){ ?>
<div class="col-sm-12 col-xs-12  panel panel-piluku ml-5">
    <button class="btn btn-primary" onclick="window.history.go(-1)">Back</button>
    <input type='button' id='btn' value='Print' class="btn btn-primary pull-right" onclick='printDiv();'>
  <div class="panel-body profile-edit">
