...
<table style="width:100%; margin-top:20px;"">
  <tr>
	...
	<p><strong>Contact: <?php $sql1 = "Select * from ".$this->config->item('db_prefix')."appointments where paitent_id='".$vl['patient_id']."' limit 1"; 
			            $query = $this->db->query($sql1);
                            $select_result3 = $query->result(); 
							foreach ($select_result3 as $res_val3){
							echo $res_val3->wife_phone;
							}
						?></strong></p>
	</td>
  </tr>
 ...
 <table style="width:100%; margin-top:30px;">
  ...
  <tr>
    <th style="width:40%;text-align:left;"colspan="1" rowspan="4"><img src="https://indiaivf.co.in/indiaivf/wp-content/uploads/2023/09/india-ivf-logo.webp"></th>
