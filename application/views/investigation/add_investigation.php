  ...
  <div class="row">
    <div class="col-sm-12 col-xs-12 panel panel-piluku">
      <div class="panel-heading">
        <h3 class="heading">Add Investigation</h3>
      </div>
      <div class="panel-body profile-edit">
        ...
        <div class="row">
		  ...
		  <label for="item_name">Vendor Name (Required)</label>
			<select name="vendor_id" required class="select2" style="display:block;">
				...
				<?php foreach($investigation_vendor as $ky => $vl){
					  $selected="";
					  if($data['ID'] == $vl['ID']){$selected="selected='selected'";}
					  ?>
          ...
          <div class="form-group col-sm-6 col-xs-12">
            ...
            <input value="" placeholder="Investigation name" id="investigation" name="investigation" type="text" class="form-control validate" required>
          </div>
        </div>     
         ...
         <div class="form-group col-sm-6 col-xs-12">
            ...
            <input value="" placeholder="USD Price" id="usd_price" name="usd_price" type="text" class="form-control validate" required>
          </div>
