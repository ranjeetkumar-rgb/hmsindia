...
function whatsappregister($phone, $patient_info=""){
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://indiaivfintegrations.curelinktech.in/register_user',
...
function whatsappregister1($phone, $customer_name, $center, $iic_id){
    
    $field_arr = array();
    $field_arr = array(
		"patient_phone" => "+91".$phone, 
		"doctor_phone" => "+918888888888", 
		"patient_info" => array( "center" => $center, "name" => $customer_name,  "iic_id" =>$iic_id),
		"send_welcome_message" => true
	);
    // var_dump($field_arr);die;
...
function whatsappappointment($phone, $params="", $element_name="appointment_confirmation"){
...
function send_mail($to, $subject, $mail_msg, $templates="")
{
	...
	$mail_host = $all_method->config->config['mail_host'];
	$mail_username = $all_method->config->config['mail_username'];
	$mail_password = $all_method->config->config['mail_password'];
	$mail_from_emailid = $all_method->config->config['mail_from_emailid'];
	$mail_from_name = $all_method->config->config['mail_from_name'];
	...
	if(!empty($templates)){
        ...
        foreach($templates as $template){
            ...
            $mail->AddAttachment($dic."/email-templates/".$template.".pdf");// add attachments
...
/** dashboard widgets */
    ...
    function day_two_embryo_rate(){
        ...
        if(!empty($m2_result) && !empty($oocytes_result)){
            ...
            foreach ($m2_result as $key => $value) {
                ...
                $m2_sum += !empty($value['cell_embryos_day2'])?$value['cell_embryos_day2']:0;
    ...
    function tese_done(){
        ...
        $sql = "SELECT count(*) as 	tese FROM tese where status!='disapproved'";
    ...
    function fnac_testes(){
        ...
        $sql = "SELECT count(*) as fnac FROM fnac where status!='disapproved'";
...
function get_center_notification(){
    ...
    $sql = "Select * from ".$db_prefix."center_stocks where quantity <= safety_stock";
    ...
    if(count($result) > 0){
        ...
        foreach($result as $key => $val){
            ...
            $exist = check_existancy($center_id, $db_prefix.'center_orders', $val['item_number']);

            if($exist == 0){ 

                if($center_id != 0){

                    $sql = "INSERT INTO ".$db_prefix."center_orders (item_number, order_quantity, create_date, update_date, center_number, status, d_status) VALUES('".$val['item_number']."', '".$val['order_qty']."', '".$date."', '".$date."', '".$center_id."', '0', '0')";
...

{
...

    {
		...
		if($nationality == "indian"){
		    ...
		    $not_field = array("reference_from", "patient_source", "wife_passport", "wife_passport_number", "husband_passport_number", "husband_passport");
...
function patient_balance($patient_id){
		...
		$consultation_result = $procedure_result = $investigation_result = $remaining_billing = $bill_arr = $bill_total = array();
		$procedure_sql = "Select receipt_number, payment_done, fees, remaining_amount, billing_from, billing_at from ".$db_prefix."patient_procedure where status!='disapproved' and patient_id='".$patient_id."'";
        $procedure_q = $ci->db->query($procedure_sql);
        $procedure_result = $procedure_q->result_array();

		$consultation_sql = "Select receipt_number, payment_done, fees, remaining_amount, billing_from, billing_at from ".$db_prefix."consultation where status!='disapproved' and patient_id='".$patient_id."'";
        $consultation_q = $ci->db->query($consultation_sql);
        $consultation_result = $consultation_q->result_array();

		$investigation_sql = "Select receipt_number, payment_done, fees, remaining_amount, billing_from, billing_at from ".$db_prefix."patient_investigations where status!='disapproved' and patient_id='".$patient_id."'";
        $investigation_q = $ci->db->query($investigation_sql);
        $investigation_result = $investigation_q->result_array();

		$total = 0;

        $done_sql = "Select sum(payment_done) as payment_done from ".$db_prefix."patient_payments where patient_id='".$patient_id."' AND status!='2'";
...
function print_pdf_patient_medical_info($patient_id){
    ...
    <tbody>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:40%;">'.$patient_result['female_wt_ht_bmi'].'</td>
    
            <td style="border:1px solid #000; width:40%;">'.$patient_result['male_wt_ht_bmi'].'</td>
    ...
    <table width="100%">
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['female_live_birth'].'</td>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['female_still_births'].'</td>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['female_abnormality_child'].'</td>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['female_pregnancy_other'].'</td>
    ...
    <table width="100%">
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['male_live_birth'].'</td>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['male_still_births'].'</td>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['male_abnormality_child'].'</td>
        ...
        <tr style="border:1px solid #000; width:40%;">
            ...
            <td style="border:1px solid #000; width:20%;">'.$patient_result['male_pregnancy_other'].'</td>
    ...
    <td colspan="2">
        ...
        <table>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['female_frequency'].'</td>
    ...
    <td style="border:1px solid #000; width:100%;">
        ...
        <table width="100%" class="border-field">
            ...
            <tr style="border:1px solid #000; width:40%;">
                <td style="border:1px solid #000; width:80%;">RESULT</td>
    ...
    <table width="100%">
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:80%;">NO. OF TIMES TESA DONE</td>
    
                <td style="border:1px solid #000; width:20%;">'.$patient_result['no_of_tesa'].'</td>
    ...
    <table width="100%">
        ...
        <table width="100%">
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['nutritional_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['psychological_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['anxious_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['pulse_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['bp_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['temp_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['cvs_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['chest_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['abdomen_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:40%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['assessment_others'].'</td>
    ...
    <td style="border:1px solid #000; width:100%;">
        ...
        <table width="100%">
            ...
            <tr style="border:1px solid #000;">
                ...
                <td style="border:1px solid #000;">Marital life</td>
    
                <td style="border:1px solid #000;">'.$patient_result['female_marital_life'].'</td>
    ...
    <td style="border:1px solid #000; width:100%;">
        ...
        <table width="100%">
            ...
            <tr style="border:1px solid #000;">
                ...
                <td style="border:1px solid #000;">'.$patient_result['male_marital_life'].'</td>
    ...
    <td style="border:1px solid #000; width:20%;">
        ...
        <table>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_obese'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_psychological_assessment'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_anxious'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_pulse'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_blood_pressure_value'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_temp'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_cvs'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_chest'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_abdomen'].'</td>
            ...
            <tr style="border:1px solid #000; width:100%;">
                ...
                <td style="border:1px solid #000; width:20%;">'.$patient_result['male_general_info_others'].'</td>
